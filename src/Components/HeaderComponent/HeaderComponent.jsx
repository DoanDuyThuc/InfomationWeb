...
export const HeaderComponent = () => {
    ...
    return (
        <section className='HeaderComponent'>
            <motion.div
                className="HeaderComponent__Title"
            ...
            >
                ...
                >I'm a developer who enjoys <span>quiet</span>, learning from <span>great</span> people, and <span>self-development</span>
                </motion.p>
                <motion.div
                    initial={{ opacity: 0, y: 50 }}
                    animate={{ opacity: 1, y: 0 }}
